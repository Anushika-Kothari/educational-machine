...
| SL. NO | FUNCTIONS |
|--------|-----------|
|1.|PRESS THE OPTION WHOSE SHAPE IS TO BE DISPLAYED.|
|2.|SENSE THE SHAPE.|
|3.|TO DETECT CORRECT SHAPE FROM THE USER.|
|4.| SEND THE SIGNAL TO THE MACHINE.|
|4.|IDENTIFICATION OF SHAPE.|
|5.|DISPLAY THE CORRECT SHAPE.|
|6.|ACTIVATE VOICE COMMAND ONCE SHAPE IS GENERATED.|
|7.|INDICATE WHEN THE PROCESS IS COMPLETED.|
...
# ****4.2 FUNCTION TREE****
![image](https://user-images.githubusercontent.com/105198072/169863625-e7e977bd-b85e-4f43-ac2b-39f18cdc7a3d.png)
