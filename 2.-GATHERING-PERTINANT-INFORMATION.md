...
<p>&nbsp;</p><table role="table" style="background-color: #0d1117; border-collapse: collapse; border-spacing: 0px; color: #c9d1d9; display: block; font-family: -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Helvetica, Arial, sans-serif, &quot;Apple Color Emoji&quot;, &quot;Segoe UI Emoji&quot;; font-size: 16px; margin-bottom: 0px !important; margin-top: 0px !important; max-width: 100%; overflow: auto; width: max-content;"><thead style="box-sizing: border-box;"><tr style="background-color: var(--color-canvas-default); border-top: 1px solid var(--color-border-muted); box-sizing: border-box;"><th style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">Project</th><th style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">Objective</th><th style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">Function</th><th style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">components</th><th style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;"></th><th style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;"><br /></th></tr></thead><tbody style="box-sizing: border-box;"><tr style="background-color: var(--color-canvas-default); border-top: 1px solid var(--color-border-muted); box-sizing: border-box;"><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">1.3d printer using arduino.</td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">To print the given sample.</td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">It will automatically prints the given sample in 3d view.</td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">Arduino mega,SMPs,Extruder,nema 17,hotend,slider,DVD slider.<br /></td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;"><br /></td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;"><br /></td></tr><tr style="background-color: var(--color-canvas-subtle); border-top: 1px solid var(--color-border-muted); box-sizing: border-box;"><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">2.Finger counter using arduino.</td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">To count the fingers.</td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;"><div class="separator" style="clear: both; text-align: center;"><br /></div>It will automatically counts the fingers .</td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;">Arduino,seven-segment LED,jumper wires,USB connector,bread board.</td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;"><br /></td><td style="border: 1px solid var(--color-border-default); box-sizing: border-box; padding: 6px 13px;"><br /></td></tr></tbody></table>
